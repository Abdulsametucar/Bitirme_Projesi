...
def test_horizontal_line(video_path, frame_pos, hsv_lower=None, hsv_upper=None):
...
c_ok = test_horizontal_line('c:/Users/Samet Uçar/Desktop/Bitirme_Projesi/havlu_takip_projesi/data/Ornek_Video.mp4', 380)
c_vid2 = test_horizontal_line('c:/Users/Samet Uçar/Desktop/Bitirme_Projesi/havlu_takip_projesi/data/Video2.mp4', 220, np.array([90, 10, 15]), np.array([140, 255, 200]))

print(f"Hatali Video (Arkaya) Horizontal Lines: {c_err}")
print(f"Ornek Video (One) Horizontal Lines: {c_ok}")
print(f"Video2 (One) Horizontal Lines: {c_vid2}")
